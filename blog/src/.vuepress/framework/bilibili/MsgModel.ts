...
import { UnknownMsg } from '../../components/kurisu/interfaces';
import { ConfigStateType, CutOffMsg, DanmakuData, DanmakuDataFormatted, DanmakuMsg, GiftBubbleMsg, GuardBuyMsg, MsgInterActWordMsg, MsgRoomBlockMsg, MsgWelcome, MsgWelcomeGuard, POPULAR, SUPER_CHAT_MESSAGE, WarningMsg } from './interfaces';
...
export async function parseData(
  data: any, config: ConfigStateType
): Promise<DanmakuDataFormatted | undefined> {
  switch (data.cmd) {
    case CmdType.LIVE:
      break;
